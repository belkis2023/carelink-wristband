...
class AppColors {
  ...
  static const Color primaryBlue = Color(
    0xFF1E5A8D,
  ); // Dark blue for icons and headers
  static const Color secondaryBlue = Color(
    0xFF4A90B8,
  ); // Medium blue for progress bars and accents
